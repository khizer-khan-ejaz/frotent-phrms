    ...
    const logoutHandler = async () => {
        try {
            const res = await axios({
                url: "https://phrmsbackend.vercel.app/api/admin/logout/",
                method: "post",
            })
                ...
                <Link to={"events"} className='flex-1'>
                    <div className={`   transition-all duration-200 cursor-pointer active:scale-[0.95] flex justify-start items-center  rounded-md h-[35px] md:h-[60px] `}>
                        ...
                        {setActiveLink("events") ? <>
                            ...
                            <button className="border-[1px] border-green-500 md:p-0 px-[10px] text-[10px] md:text-[15px] lg:text-[18px] w-[100%]  rounded-md hover:text-white  relative flex h-[35px] md:h-[45px] lg:h-[50px] text-green-500   items-center justify-center overflow-hidden bg-white   transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-green-500 before:duration-500 before:ease-out hover:shadow-green-600 hover:before:h-56 hover:before:w-56">
                                ...
                                <span className="hover:text-white md:hidden lg:flex relative z-10 font-[500] text-[10px] md:text-[15px] lg:text-[18px] flex w-[100%] justify-center items-center gap-[10%] ">    Events </span>
                            </button>
                        }
                ...
                <Link to={"blogs"} className='flex-1'>
                    <div className={` transition-all duration-200 cursor-pointer active:scale-[0.95] flex justify-start items-center  rounded-md h-[35px] md:h-[60px] `}>
                        ...
                        {setActiveLink("blogs") ? <>
                            ...
                            <button className=" border-[1px] border-green-500 md:p-0 px-[10px] text-[10px] md:text-[15px] lg:text-[18px] w-[100%] m-0 rounded-md hover:text-white  relative flex h-[35px] md:h-[45px] lg:h-[50px] text-green-500   items-center justify-center overflow-hidden bg-white    transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-green-500 before:duration-500 before:ease-out hover:shadow-green-600 hover:before:h-56 hover:before:w-56">
                                ...
                                <span className=" hover:text-white md:hidden lg:flex relative z-10 font-[500] text-[10px] md:text-[15px] lg:text-[18px] flex w-[100%] justify-center items-center gap-[20px] ">   Blogs </span>
                            </button>
                        </>}
                    ...
                    <div className={` transition-all duration-200 cursor-pointer active:scale-[0.95] flex justify-start items-center rounded-md h-[35px] md:h-[60px] `}>
                        ...
                        {setActiveLink("cause") ? <>
                            ...
                            <button className="border-[1px] border-green-500 md:p-0 px-[10px] text-[10px] md:text-[15px] lg:text-[18px] w-[100%] m-0 rounded-md hover:text-white  relative flex h-[35px] md:h-[45px] lg:h-[50px] text-green-500   items-center justify-center overflow-hidden bg-white   transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-green-500 before:duration-500 before:ease-out hover:shadow-green-600 hover:before:h-56 hover:before:w-56">
                                ...
                                <span className=" hover:text-white relative md:hidden lg:flex z-10 font-[500] text-[10px] md:text-[15px] lg:text-[18px] flex w-[100%] justify-center items-center gap-[20px] ">   Cause </span>
                ...
                <div className='flex-1'>
                    <div onClick={logoutHandler} className={` transition-all duration-200 cursor-pointer active:scale-[0.95] flex justify-start items-center rounded-md h-[35px] md:h-[60px] `}>
                        ...
                        <button className="border-[1px] border-green-500 md:p-0 px-[10px] text-[10px] md:text-[15px] lg:text-[18px] w-[100%] m-0 rounded-md hover:text-white  relative flex h-[35px] md:h-[45px] lg:h-[50px] text-green-500   items-center justify-center overflow-hidden bg-white   transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-green-500 before:duration-500 before:ease-out hover:shadow-green-600 hover:before:h-56 hover:before:w-56">
                            ...
                            <span className=" hover:text-white relative md:hidden lg:flex z-10 font-[500] text-[10px] md:text-[15px] lg:text-[18px] flex w-[100%] justify-center items-center gap-[20px] ">   Logout </span>
